...
<a name="lzAHW"></a>
### 1.1 云原生迁移平台的需求说明
迁移和容灾作为云管平台重要的一个模块，在多云环境下已经变得越来越重要。传统的云管平台中，更多的是通过云平台API接口对单一云平台进行纵向调度，即使进行多云的混合调度编排，但是仍然无法解决数据层面的互联互通问题。云迁移和容灾平台有效的打通了多云之间数据层面的互通问题，让用户自助式的完成在不同云平台之间的负载切换。<br />![Picture1.png](https://cdn.nlark.com/yuque/0/2020/png/759715/1586560312758-f7a90a8a-787b-492f-8ee5-7a34fa3a046f.png#align=left&display=inline&height=849&name=Picture1.png&originHeight=849&originWidth=1706&size=474549&status=done&style=none&width=1706)<br />[https://www.gartner.com/document/3873016](https://www.gartner.com/document/3873016) 
<a name="0TKNZ"></a>
### 1.2 云原生迁移平台迁移需求
根据云迁移策略的定义，常见的七种策略有：重新托管（Rehosting）、更换平台（Replatforming）、重新购买（Repurchasing）、重构（Refactoring/Re-architecting）、退役（Retire）、保留（Retian）。<br />![image.png](https://cdn.nlark.com/yuque/0/2020/png/759715/1586560760218-d28c26db-f98b-4f30-b4e6-f870d8430459.png)<br />在混合云环境下，对于用户成本最低、效率最高的方式就是重新托管（Rehosting）方式，即原封不动照搬过来，用户从操作系统到应用系统都不会发生任何改变，可以在线迁移，迁移之后可以立即使用。
<a name="JZtTe"></a>
### 1.3 云原生迁移平台需求定义
...
<a name="MKWiG"></a>
#### 整体架构
云管平台通过云原生迁移平台提供的RESTful API接口进行对接，调度迁移平台完成迁移操作。<br />![Picture2.png](https://cdn.nlark.com/yuque/0/2020/png/759715/1586561311319-3e7859d0-8272-4e96-9e45-c279d4b540eb.png)
<a name="kWwUD"></a>
#### 对接流程
![](https://cdn.nlark.com/yuque/__puml/299d141b18a45ec78efc7fa786782fab.svg#lake_card_v2=eyJjb2RlIjoiQHN0YXJ0dW1sXG465rqQ56uv546v5aKD5YeG5aSHO1xubm90ZSBsZWZ0XG5BZ2VudOaWueW8j-mcgOimgeW8leWvvOeUqOaIt-i_m-ihjOWuieijheW5tuazqOWGjFxu5peg5Luj55CG5pa55byP6ZyA6KaB5o-Q5YmN6YWN572u5aW9dkNlbnRlcuS_oeaBr--8jFxu55So5oi35Y-v5Lul55u05o6l6YCJ5oup6Jma5ouf5py66L-b6KGM6L-B56e7XG5lbmQgbm90ZVxuOuebruagh-W5s-WPsOWHhuWkhztcbm5vdGUgcmlnaHRcbuWmguaenOS9v-eUqOWNleenn-aIt-WQjOatpe-8jOivpeatpemqpOWPr-S7peWcqOmDqOe9slxu6Zi25q615a6M5oiQ77yM5peg6aG75a-55o6lXG7lpoLmnpzkuLrlpJrnp5_miLflkIzmraXvvIzor6XmraXpqqTpnIDopoHkupHnrqHlubPlj7BcbuWIm-W7uuS6keS4u-acuuW5tuaJp-ihjOWuieijheaTjeS9nOWQjuiwg-eUqOaOpeWPo-azqFxu5YaM5Zue6L-B56e75bmz5Y-wXG5lbmQgbm90ZVxuOumihOajgDtcbm5vdGUgbGVmdFxu6K-l5q2l6aqk5Li76KaB55Sx5LqR566h5bmz5Y-w5a-55b6F6L-B56e75Li75py66L-b6KGMXG7lkIjop4TmgKfmo4Dmn6XvvIzliKTmlq3mmK_lkKbmu6HotrPov4Hnp7vnmoTln7rmnKzmnaFcbuS7tu-8jOespuWQiOadoeS7tuWQjuaJjeWFgeiuuOi_m-WFpeS4i-S4gOatpVxuZW5kIG5vdGVcbjrms6jlhozlvoXov4Hnp7vkuLvmnLo7XG5ub3RlIHJpZ2h0XG7ms6jlhozkuLvmnLrmiJDkuLrlvoXov4Hnp7vkuLvmnLrvvIzov5vlhaXov4Hnp7vmtYHnqItcbmVuZCBub3RlXG465pWw5o2u5ZCM5q2lO1xubm90ZSBsZWZ0XG7mlK_mjIHlhajph4_lkIzmraXlkozlop7ph4_lkIzmraXvvJtcbuWPr-S7peWBnOatouWQjOatpeWSjOaWreeCuee7reS8oDtcbuWPr-S7peiuvuWumuWRqOacn-aAp-W_q-eFp-etlueVpe-8jOiHquWKqOi_m-ihjOWumuaXtuWQjOatpTtcbmVuZCBub3RlXG466aqM6K-BL-WQr-WKqOS4u-acujtcbm5vdGUgcmlnaHRcbuagueaNruinhOagvOi_m-ihjOWQr-WKqOWQjumqjOivgeaIluato-W8j-WQr-WKqOS4u-acujtcbmVuZCBub3RlXG465riF55CG6LWE5rqQO1xubm90ZSBsZWZ0XG7muIXnkIbpmaTmraPlvI_lkK_liqjnmoTkupHkuLvmnLrlpJbnmoTlhajpg6jotYTmupA7XG5lbmQgbm90ZVxuQGVuZHVtbCIsInR5cGUiOiJwdW1sIiwiaWQiOiJONHZwQiIsInVybCI6Imh0dHBzOi8vY2RuLm5sYXJrLmNvbS95dXF1ZS9fX3B1bWwvMjk5ZDE0MWIxOGE0NWVjNzhlZmM3ZmE3ODY3ODJmYWIuc3ZnIiwiY2FyZCI6ImRpYWdyYW0ifQ==)<a name="LGUKj"></a>
### 2.2 源端场景说明
<a name="8xYy9"></a>
#### 2.2.1 代理方式使用（Agent）
