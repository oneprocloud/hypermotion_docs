...
Access Key ID | 腾讯云的个人账户密钥ID  (详情参见附录二 腾讯云平台认证信息获取)
AccessKeySecret  | 腾讯云的个人账户密钥(详情参见 附录二 腾讯云平台认证信息获取)
...
镜像ID | 创建的腾讯云的镜像ID（详情参见附录二 腾讯云平台认证信息获取）
